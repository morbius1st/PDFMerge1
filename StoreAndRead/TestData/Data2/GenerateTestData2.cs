...
namespace StoreAndRead.TestData.Data2
{
	...
	#region ctor
		...
		public GenerateTestData2(string dataName)
		{
	...
	#region public methods
		...
		{
			ObservableCollection<TestItem> DataRoot2 = new ObservableCollection<TestItem>();
...
//			TestItem branch;
			...
			// leaf 1
			DataRoot2.Add(MakeItem(1.0, "leaf"));

			// branch 2
			DataRoot2.Add(SubLeaves(2.0, 3, 0.1, 0));

			// leaf 3
			DataRoot2.Add(MakeItem(3.0, "leaf"));

			// branch 4
			DataRoot2.Add(SubLeaves(4.0, 3, 0.1, 2));
