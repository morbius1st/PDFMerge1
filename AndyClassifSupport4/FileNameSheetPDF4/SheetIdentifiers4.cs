...
using static AndyShared.FileSupport.FileNameSheetPDF4.SheetIdentifiers4.ShtIdClass2;
...
{
	public class SheetIdentifiers4
	{
		static SheetIdentifiers4()
		{
			initialized = true;

			_fileNameSheetIdentifiers = new SheetIdentifiers4();

		}

		private static bool initialized = false;

		private static SheetIdentifiers4 _fileNameSheetIdentifiers;

		public static SheetIdentifiers4 ShtIds2
		{
			get
			{
				if (!initialized)
		...
		public static readonly int[] IDX_XLATE = new []
		{
			SI_PHBLDG, SI_DISCIPLINE,
			SI_CATEGORY, SI_SUBCATEGORY, 
			SI_MODIFIER, SI_SUBMODIFIER, 
			SI_IDENTIFIER, SI_SUBIDENTIFIER
		};

		public readonly int IDX_XLATE_MIN = IDX_XLATE[0];
		public readonly int IDX_XLATE_MAX = IDX_XLATE[IDX_XLATE.Length - 1];
