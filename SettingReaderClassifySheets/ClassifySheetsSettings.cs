...
namespace SettingReaderClassifySheets
{

	// this is an example file only, andy shared is a shared project so it does not have
	// a user setting file
	public class ClassifySheetsSettings
	{
		public ClassifySheetsSettings()
		{
			UserSettings.Path.settingFilePath = @"C:\Users\jeffs\AppData\Roaming\CyberStudio\Andy\ClassifySheets\user.setting.xml";
