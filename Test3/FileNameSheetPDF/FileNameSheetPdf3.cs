...
// updated version of FiloNameSheetPdf that actually correctly parses sheet numbers
// based on a wider range of possible sheet numbers


namespace Test3.FileNameSheetPDF
{
	public class FileNameSheetPdf3 : FileNameSimple
	{
	...
	#region public properties
		...
		public ShtNumber ShtNumber => shtNumber;
	...
	#region private methods
		...
		private void config()
		{
			...
			{
				shtNumber = new ShtNumber(null);

				return;
			}

			shtNumber = new ShtNumber(OrigShtNumber, true);
	...
	#region system overrides
		...
		{
			return $"this is {nameof(FileNameSheetPdf3)}";
		}
