...
namespace StatusMgr
{
	...
	public class StatusMgrData : IStatusMgrData
	{
		public Dictionary<StatCodeGroups, string> StatusGroupDesc { get; } = new Dictionary<StatCodeGroups, string>()
		{
			{ SCG_G,   "General" },
		...
		public Dictionary<StatusCodes, Tuple<StatCodeGroups, string>> StatusDesc { get; } =
			new Dictionary<StatusCodes, Tuple<StatCodeGroups, string>>()
			{
