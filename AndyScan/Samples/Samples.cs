		...
		{
			{
				...
				new Sample(0, 
					"Sample TestBoxes",
					null, null, null, null,
					DATA_FILE_FOLDER+@"SheetMetric0.xml",
					ROOT_PATH_01,
					DATA_FILE_FOLDER+@"Sheet Metric 0.pdf",
					null
					)
			},
			{
				...
				new Sample(1, 
					...
					null, null, null, null,
					DATA_FILE_FOLDER+@"SheetMetric1.xml",
					DATA_FILE_FOLDER+@"Test1\",
					DATA_FILE_FOLDER+@"Sheet Metric 1.pdf", 
					null
					)
			},
			{
				...
				new Sample(2, 
					...
					null, null, null, null,
					DATA_FILE_FOLDER+@"SheetMetric2.xml",
					DATA_FILE_FOLDER+@"Test\title blocks\",
					DATA_FILE_FOLDER+@"Sheet Metric 2.pdf",
