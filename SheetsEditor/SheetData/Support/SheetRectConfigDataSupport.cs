...
using System.Text;
using static SheetEditor.Support.SheetRectType;
using static SheetEditor.Support.SheetRectId;
...
namespace SheetEditor.Support
{
	...
	public class SheetRectConfigDataSupport
	{
		...
		public static Dictionary<string, SheetRectConfigData<SheetRectId>> ShtRectIdXref { get; } = new Dictionary<string, SheetRectConfigData<SheetRectId>>()
		{
			...
			{ "Sheet Boundary"   , new SheetRectConfigData<SheetRectId>(SRT_NA,SM_SHT) }                    , // size of sheet
			{ "SHEET XREF"       , new SheetRectConfigData<SheetRectId>(SRT_BOX,SM_XREF) }                  , // the box style for sheet xrefs
			{ "SHEET NUMBER FIND", new SheetRectConfigData<SheetRectId>(SRT_LOCATION,SM_SHT_NUM_FIND) }     , // limits to find the sheet number
			{ "SHEET TITLE"      , new SheetRectConfigData<SheetRectId>(SRT_LOCATION,SM_SHT_TITLE) }        , // where to find the title of the sheet

			{ "SHEET NUMBER"     , new SheetRectConfigData<SheetRectId>(SRT_LINK_N_BOX,SM_SHT_NUM) }        , // where to place the sheet number box
			{ "AUTHOR"           , new SheetRectConfigData<SheetRectId>(SRT_LINK_N_BOX,SM_AUTHOR) }         , // the information for the author box
			{ "DISCLAIMER"       , new SheetRectConfigData<SheetRectId>(SRT_TEXT_LINK_N_BOX,SM_DISCLAIMER) }, // the information for the disclaimer
			{ "FOOTER"           , new SheetRectConfigData<SheetRectId>(SRT_TEXT_N_BOX,SM_FOOTER) }         , // the information for the footer
			{ "FIRST BANNER"     , new SheetRectConfigData<SheetRectId>(SRT_TEXT_N_BOX,SM_BANNER_1ST) }     , // the information for the banner
			{ "SECOND BANNER"    , new SheetRectConfigData<SheetRectId>(SRT_TEXT_N_BOX,SM_BANNER_2ND) }     , // ditto
			{ "THIRD BANNER"     , new SheetRectConfigData<SheetRectId>(SRT_TEXT_N_BOX,SM_BANNER_3RD) }     , // ditto
			{ "FOURTH BANNER"    , new SheetRectConfigData<SheetRectId>(SRT_TEXT_N_BOX,SM_BANNER_4TH) }     , // ditto
			{ "WATERMARK1"       , new SheetRectConfigData<SheetRectId>(SRT_TEXT,SM_WATERMARK1) }           , // the information for the main watermark
			{ "WATERMARK2"       , new SheetRectConfigData<SheetRectId>(SRT_TEXT,SM_WATERMARK2) }           , // the information for the title block watermark
		};
